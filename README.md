...
:root {
  /* Academic Modern Design - Slate Blue & Sage Green */
  --primary: oklch(0.42 0.12 264); /* Slate Blue */
  --primary-foreground: oklch(0.98 0.001 0);
  --sidebar-primary: oklch(0.42 0.12 264);
  --sidebar-primary-foreground: oklch(0.98 0.001 0);
  --chart-1: oklch(0.65 0.15 150); /* Sage Green */
  --chart-2: oklch(0.42 0.12 264); /* Slate Blue */
  --chart-3: oklch(0.55 0.12 264);
  --chart-4: oklch(0.42 0.12 264);
  --chart-5: oklch(0.35 0.12 264);
  --radius: 0.75rem;
  --background: oklch(0.99 0 0); /* Pure White */
  --foreground: oklch(0.15 0.01 264); /* Almost Black */
  --card: oklch(0.99 0 0);
  --card-foreground: oklch(0.15 0.01 264);
  --popover: oklch(0.99 0 0);
  --popover-foreground: oklch(0.15 0.01 264);
  --secondary: oklch(0.65 0.15 150); /* Sage Green */
  --secondary-foreground: oklch(0.15 0.01 264);
  --muted: oklch(0.92 0.01 264); /* Light Gray */
  --muted-foreground: oklch(0.52 0.01 264);
  --accent: oklch(0.65 0.15 150); /* Sage Green */
  ...
  --sidebar-border: oklch(0.93 0.01 264);
  --sidebar-ring: oklch(0.42 0.12 264);
}
...
.dark {
  ...
  --chart-2: oklch(0.55 0.12 264);
  --chart-3: oklch(0.65 0.12 264);
  --chart-4: oklch(0.55 0.12 264);
  --chart-5: oklch(0.45 0.12 264);
  --sidebar: oklch(0.22 0.01 264);
